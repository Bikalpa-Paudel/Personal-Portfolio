import "./MyImg.css"
import Bikalpa from "./Bikalpa1m.png"
export default function MyImg(){
    return(
        <>
            <div className="myimg-container">
                <svg id="myimg-svg" viewBox="0 0 480 505" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <image xlinkHref={Bikalpa} width="480" height="505" preserveAspectRatio="xMidYMid meet" />
                </svg>
            </div>
        </>
    )
